...
<main>
	<form action="conn/inserimento.php" method="POST" enctype="multipart/form-data">
		...
		<span class="warning">N.B.: dimensoni 350x250</span>
		<input type="file"  name="immagine" required/><br>
		<span class="special">Titolo</span><br>
		<input type="text" name="titolo" placeholder="Inserisci il titolo dell'articolo" autofocus required/><br>
		...
		<input type="text" name="tag" placeholder="Inserisci il tag dell'articolo"  required/><br>
		...
		per inserire titoli in grassetto segurie il formato &lt;h3&gt;testo&lt;/h3&gt;	<br>
		...
		<textarea placeholder="Inserisci il corpo dell'articolo" name="corpo" required></textarea>

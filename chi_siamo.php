...
I target primari sono le fasce deboli ovvero chi si interfaccia per la prima volta nello strano mondo del web.  
In una società dove lo strumento informatico è utilizzato ormai da ogni genere di utente ,sia  giovane sia anziano,
riteniamo che non sia tanto ostico il l'approccio con il web ma  , invece, piuttosto pericoloso.
Il web è un mondo così tanto affascinate e ricco che pericoloso se non si sanno riconoscere le numerose insidie che si prensentano. Noi attraverso seminari in scuole primarie e secondarie, grazie alle nostre conoscenze ed esperienze personali, vi aiuteremo a capire come usare il web in modo sicuro ed efficace.
				<br><br>
				<h3>COME CONTATTARCI?</h3>
				Potete contattarci tramite mail e numeri di telefono presenti <a href="#contatti">qui</a>!
				<br>
				</div>

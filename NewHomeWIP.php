...
<meta charset="utf-8">
	...
	<link href="style/WIP.css" rel="stylesheet" type="text/css">
	...
	<div id="infocookie">
		...
		<div id="container">
			...
			<div class="contMembri">
				<h3>Membri</h3>
		
						<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/davide.png" style="width: 100%;" alt="foto utente"/></div>
							<div class="centra_testo_scorr">
						...
						<div class="slide-img">
							<a href=""><div class ="imgMembro"> <img src="img/membri2/paolo.png" style="width: 100%;" alt="foto utente"/></div>
							<div class="centra_testo_scorr">
						...
						<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/raff.png" style="width: 100%;" alt="foto utente"/></div>
							<div class="centra_testo_scorr">
								<p>Raffaele Marino</p>
								<p>Segretario</p>
								<p>Web Manager</p>
						...
						<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/matt.png" style="width: 100%;" alt="foto utente"/></div>
							<div class="centra_testo_scorr">
								<p>Matteo Pastore</p>
								<p>Consigliere</p>
							...
							<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/silvio.png" style="width: 100%;" alt="foto utente"/></div>
							<div class="centra_testo_scorr">
								<p>Silvio Corso</p>
								<p>Tesoriere</p>
						...
						<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/angelo.png" style="width: 100%; " alt="foto utente"/></div>
							<div class="centra_testo_scorr">
						...
						<div class="slide-img">
							<a href=""><div class ="imgMembro"> <img src="img/membri2/mario.png" style="width: 100%;" alt="foto utente" /></div>
							<div class="centra_testo_scorr">
								<p>Mario Santoro</p>
						...
						<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/fonz.png" style="width: 100%;" alt="foto utente" /></div>
							<div class="centra_testo_scorr">
						...
						<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/pino.png" style="width: 100%;" alt="foto utente" /></div>
							<div class="centra_testo_scorr">
						...
						<div class="slide-img">
							<a href=""><div class ="imgMembro"> <img src="img/membri2/enzo.png" style="width: 100%;" alt="foto utente" /></div>
							<div class="centra_testo_scorr">
								<p>Vincenzo Sabato</p>
						...
						<div class="slide-img">
							<a href=""> <div class ="imgMembro"><img src="img/membri2/erminio.png" style="width: 100%;" alt="foto utente" /></div>
							<div class="centra_testo_scorr">
								<p>Erminio Acierno</p>
								<p>Articles Writer</p>
								<br>
			...
			<div class="contArticoli">
			    <h3>Articoli</h3>
			    <?php
			    $out.="<div class=\"singArt\">
			            
			            <div class=\"imgArt\">
			            <img src=\"img/uploads/articolo1.png\" style=\"width: 100px;\">
			            </div>
			            <div class=\"testoArt\">
			             <h3>Prova Articolo</h3>
			             ScrittoreMaggggico
			             <br>
			             data 00/00/0000
			            </div>
